...
const TECH_BG = "/attached_assets/generated_images/abstract_cybernetic_circuit_board_pattern%2C_soft_blue_glow.png";
  ...
  return (
    <section id="features" className="py-24 relative overflow-hidden bg-background">
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <img src={TECH_BG} alt="Tech Texture" className="w-full h-full object-cover" />
      </div>
